...
class YelpClassifier(object):
    ...
    def calculate_likelihoods(self, train_rdd):
        ...
        class_likelihoods = train_rdd \
                             .flatMap(self.review_to_word_count) \
    ...
    def calculate_num_reviews_and_words_per_num_stars(self, train_rdd):
        ...
        num_reviews_words_per_num_stars = train_rdd \
                                             ...
                                             .reduceMap(add_review_and_word_counts)
    ...
    def classify_reviews(self, test_rdd):
        ...
        predictions = test_rdd \
                            ...
                            .reduceMap(self.add_log_likelihoods) \
                            .map(self.likelihood_to_posterior) \
                            .map(self.review_id_only_as_key) \
                            .reduceMap(self.find_max_posterior) \
                            .sortByKey()
    ...
    def counts_to_probabilities(self, num_stars_and_word_counts):
        ...
        num_stars = num_stars_and_word_counts[0]
        word_counts = num_stars_and_word_counts[1]
        probability = compute_likelihood(self, word_counts, num_stars)
    ...
    def add_review_and_word_counts(count1, count2):
        ...
        num_stars = count1[0]
        num_reviews_of_num_stars = count1[1][0] + count2[1][0]
        num_words_total_of_num_stars = count1[1][1] + count2[1][1]
        return (num_stars, (num_reviews_of_num_stars, num_words_total_of_num_stars))
        raise NotImplementedError()
...
#6
        review_id = num_stars_posterior1[0]
        num_stars1 = num_stars_posterior1[1][0]
        log_posterior1 = num_stars_posterior1[1][1]
        num_stars2 = num_stars_posterior2[1][0]
        log_posterior2 = num_stars_posterior2[1][1]
        if log_posterior2 > log_posterior1:
           return (review_id, (num_stars2, log_posterior2))
        else:
           return (review_id, (num_stars1, log_posterior1))
        raise NotImplementedError()
